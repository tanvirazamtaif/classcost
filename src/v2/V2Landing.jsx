...
export function V2Landing({ onGuest }) {
  ...
  const card = { background: 'rgba(20,23,50,.92)', backdropFilter: 'blur(16px)', border: `1px solid ${BORDER}` };

  return (
    <div className="min-h-screen relative overflow-hidden" style={{ background: '#101228', fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" }}>
