  ...
  return (
    <div className="v2-scroll">
      ...
      <div className="px-4">
        ...
        <div className="rounded-2xl p-4 mb-4" style={{ background: 'var(--hero-bg)', border: '1.5px solid var(--hero-border)' }}>
        ...
        <div className="overflow-hidden" style={{ minHeight: 320, background: 'var(--card)', border: '1.5px solid var(--border)', borderRadius: '1rem', boxShadow: 'var(--card-shadow)' }}>
          {tops.map((s, i) => {
  ...
  return (
    <div className="v2-drawer-backdrop" onClick={onClose}>
      <aside className="v2-drawer" onClick={(e) => e.stopPropagation()}>
        {/* masthead */}
        <div className="flex items-center gap-2.5 pb-3 mb-4 px-0.5" style={{ borderBottom: '1.5px solid var(--border)' }}><Logo size={30} /><span className="text-[17px] font-bold t-hi t-serif">ClassCost</span></div>

        {/* profile — framed */}
        <button className="w-full text-left flex items-center gap-3 p-2.5 mb-5" onClick={() => go(() => nav('profile'))} style={{ border: '1.5px solid var(--border)', borderRadius: 12, background: 'var(--card)' }}>
          <span className="w-10 h-10 rounded-full flex items-center justify-center text-white text-base font-semibold shrink-0" style={{ background: '#22c55e', border: '1.5px solid var(--border)' }}>{initial}</span>
        ...
        <div className="mb-5" style={{ border: '1.5px solid var(--border)', borderRadius: 12, overflow: 'hidden' }}>
...
function CostsBox({ costs, onOpen, onAdd }) {
  ...
  return (
    <div className="overflow-hidden mb-5" style={{ minHeight: 320, background: 'var(--card)', border: '1.5px solid var(--border)', borderRadius: '1rem', boxShadow: 'var(--card-shadow)' }}>
  ...
  return (
    <div className="v2-scroll" style={{ overflowX: 'hidden', paddingBottom: 124 }}>
      ...
      <div className="fixed left-0 right-0 z-[41]" style={{ bottom: 52, maxWidth: 480, margin: '0 auto' }}>
        <div className="flex" style={{ background: 'var(--sheet-bg)', borderTop: '1.5px solid var(--border)', borderBottom: '1.5px solid var(--border)' }}>
    ...
    <div className="v2-scroll">
      ...
      <div className="px-4 py-4 space-y-3">
        ...
        {rows.length === 0
          ...
          : <div style={{ border: '1.5px solid var(--border)', borderRadius: 12, overflow: 'hidden' }}>{rows.map((dd, i) => { const dt = parse(dd.date); return (
    ...
    <div className="v2-backdrop" onClick={onClose}>
      <div className="v2-sheet" onClick={(e) => e.stopPropagation()}>
        ...
        {cands.length === 0
          ...
          : <div style={{ border: '1.5px solid var(--border)', borderRadius: 12, overflow: 'hidden' }}>{cands.map((sp, i) => {
      ...
      <div className="px-4 py-4 space-y-4">
        ...
        <div>
          ...
          {trackRows.length === 0
            ...
            : <div style={{ border: '1.5px solid var(--border)', borderRadius: 14, overflow: 'hidden' }}>{trackRows.slice(0, 80).map(({ d, from }, i) => { const dt = parse(d.date); const fromBal = (d.fromBalance || 0) > 0; const isEng = from.kind === 'rentengine'; return (
  ...
  const body = (
    <div className="py-3">
      <div className="flex flex-col items-center text-center mb-4 px-2">
        ...
        <div className="flex mt-4 w-full max-w-[280px]" style={{ border: '1.5px solid var(--border)', borderRadius: 12, overflow: 'hidden' }}>
  ...
  return (
    <div className="fixed z-[46] flex flex-col" style={{ inset: 0, background: 'var(--bg)' }}>
      <div className="flex flex-col" style={{ maxWidth: 480, margin: '0 auto', width: '100%', height: '100%' }}>
        ...
        <div className="px-3 py-2.5 flex items-center gap-2" style={{ borderTop: '1.5px solid var(--border)', background: 'var(--sheet-bg)' }}>
