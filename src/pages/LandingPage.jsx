            ...
            <div className="relative w-full max-w-[420px]">
              ...
              <div className="bg-[#111118]/80 backdrop-blur-xl border border-white/[0.08] rounded-[24px] p-8 lg:p-10 relative z-10 shadow-[0_20px_60px_rgba(0,0,0,.5)]">
                ...
                <button onClick={handleContinue} disabled={loading}
                  className="w-full text-sm font-semibold rounded-xl py-3.5 flex items-center justify-center gap-2 transition-all active:scale-[0.98] disabled:opacity-50 bg-green-600 hover:bg-green-500 text-white shadow-lg shadow-green-600/20">
                  {loading ? <><div className="w-4 h-4 border-2 border-green-300 border-t-white rounded-full animate-spin" />Sending code...</> : "Continue with Email"}
                </button>
