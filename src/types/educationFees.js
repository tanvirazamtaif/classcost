...
export const EDUCATION_FEE_TYPES = [
  ...
  },
  {
    ...
    icon: '👥',
    label: 'Batch / Program',
    desc: 'Batch or program fees',
    defaultPattern: PAYMENT_PATTERNS.ONE_TIME,
    allowedPatterns: [PAYMENT_PATTERNS.ONE_TIME, PAYMENT_PATTERNS.RECURRING, PAYMENT_PATTERNS.SEMESTER],
    fields: ['name', 'amount', 'dueDay'],
    isMultiEntry: true,
  },
  {
    id: 'private_tutor',
    ...
    fields: ['tutorName', 'subject', 'amount', 'paymentType', 'dueDay', 'reminder', 'ratePerClass'],
    isMultiEntry: true,
  },
  ...
  },
  {
    ...
    desc: 'Club memberships (recurring)',
    defaultPattern: PAYMENT_PATTERNS.YEARLY,
    allowedPatterns: [PAYMENT_PATTERNS.YEARLY, PAYMENT_PATTERNS.RECURRING, PAYMENT_PATTERNS.SEMESTER],
  ...
  },
  {
    ...
    icon: '🎪',
    label: 'School Events',
    desc: 'Science fair, sports day, etc.',
    defaultPattern: PAYMENT_PATTERNS.ONE_TIME,
  ...
  },
  {
    ...
    icon: '👔',
    label: 'Uniform',
    desc: 'School uniform purchases',
    defaultPattern: PAYMENT_PATTERNS.ONE_TIME,
    fields: ['purchaseDate', 'description', 'amount'],
    isMultiEntry: true,
  },
...
export const FEE_TYPE_LEVELS = {
  ...
  clubs: ['school', 'college', 'university'],
  events: ['school', 'college', 'university'],
...
export const DYNAMIC_FEE_LABELS = {
  ...
  clubs: {
    school: 'School Clubs',
    college: 'College Clubs',
    university: 'University Clubs',
    default: 'Clubs & Activities',
  },
  events: {
  ...
  batch: {
    school: 'Coaching Batch',
    college: 'Admission Batch',
